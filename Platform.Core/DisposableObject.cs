...
namespace DDCloud.Platform.Core
{
        ...
        : IDisposable
    {
        ...
        /// </summary>
		[SuppressMessage("Microsoft.Design", "CA1063:ImplementIDisposableCorrectly", Justification = "Actually, this is correct behaviour - Dispose will only be called once.")]
		~DisposableObject()
        {
