...
namespace DDCloud.Platform.Core.CodeAnalysis
{
	...
	public sealed class ContractAnnotationAttribute
		: Attribute
	{
		/// <summary>
		///		Declare a contract annotation for the specified method.
		/// </summary>
		/// <param name="fdt">
		///		A function-definition table row representing the contract annotation.
		/// </param>
		...
		///		Force full (ie. pessimistic) state state machine analysis?
		/// </param>
